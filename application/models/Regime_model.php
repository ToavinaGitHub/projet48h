...
class Regime_model extends CI_Model{
    ...
    public function getregime(){
        $query=$this->db->query('SELECT u.idRegime,u.duree,o.nom as nomObj,u.poids,u.details,u.montant,u.pourcViande,u.pourcPoisson,u.pourcVolaille FROM regime u  join objectif o on u.idObjectif=o.idObjectif ');
    ...
    public function insert($duree,$idob,$poids,$detail,$sexe,$montant,$viande,$poisson,$poulet) {
        $query = $this->db->query('insert into regime(idRegime,duree,idObjectif,poids,details,sexe,montant,pourcViande,pourcPoisson,pourcVolaille) values (null,?,?,?,?,?,?,?,?,?)', array($duree,$idob,$poids,$detail,$sexe,$montant,$viande,$poisson,$poulet));
