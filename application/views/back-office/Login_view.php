                ...
                <div class="card rounded-3 text-black">
                    <div class="row g-0">
                        <div class="col-lg-6">
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <form method="post" action="<?php echo base_url('Admin_controller/login') ?>" data-parsley-validate id="form">
                                    ...
                                    <div class="form-outline mb-4">
                                        <div class="user-box">
                                            <input type="text" name="email" id="email" required data-parsley-required="true" data-parsley-type="email" value="itu@gmail.com">
                                    ...
                                    <div class="form-outline mb-4">
                                        <div class="user-box">
                                            <input type="password" name="mdp" required data-parsley-minlength="6" value="itu">
                         ...
                         <img class="col-lg-6 d-flex align-items-center gradient-custom-2" src="<?php echo base_url("assets/img/logAdmin.jpg") ?>">
                        <div class="text-right">
                            <a href="<?php echo base_url("Login_controller") ?>" class="btn btn-link btn-sm">Client</a>
                        </div>
                    </div>
                </div>
            </div>
